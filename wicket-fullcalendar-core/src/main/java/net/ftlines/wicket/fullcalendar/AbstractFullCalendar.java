...
abstract class AbstractFullCalendar extends WebComponent implements IHeaderContributor
{
	...
	protected String getActionScript(String action, Map<String, Object> parameters, String placeholder)
	{
		String url = action;
		if (parameters != null)
		{
	...
	protected abstract void onAction(String action, Request request, AjaxRequestTarget target);
	...
	private class CallbackBehavior extends AbstractDefaultAjaxBehavior
	{
		...
		{
			return super.getCallbackUrl(onlyTargetActivePage) + "&fcx:action=<URL>";
		}
