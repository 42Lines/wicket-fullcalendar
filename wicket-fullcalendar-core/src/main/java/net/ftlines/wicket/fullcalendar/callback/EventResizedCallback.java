...
public abstract class EventResizedCallback extends
	...
	public String getHandlerScript() {
		return "function(event, dayDelta, minuteDelta,  revertFunc) { "
				+ getCallbackScript() + "}";
	}
	...
	protected boolean onEvent(AjaxRequestTarget target) {
		...
		return onEventResized(new ResizedEvent(source, event, dayDelta,
				minuteDelta), new CalendarResponse(getCalendar(), target));

	}

	protected abstract boolean onEventResized(ResizedEvent event,
