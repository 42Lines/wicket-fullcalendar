...
public class HomePage extends WebPage {
	...
	public HomePage(final PageParameters parameters) {
		...
		FullCalendar calendar = new FullCalendar("cal", config) {
			...
			@Override
			protected boolean onEventDrop(EventSource source, Event event,
					int dayDelta, int minuteDelta, boolean allDay,
					AjaxRequestTarget target) {
				info("Event drop. eventId: " + event.getId() + " sourceId: "
						+ source.getUuid() + " dayDelta: " + dayDelta
			...
			@Override
			protected boolean onEventResize(EventSource source, Event event,
					int dayDelta, int minuteDelta, AjaxRequestTarget target) {
				info("Event resized. eventId: " + event.getId() + " sourceId: "
						+ source.getUuid() + " dayDelta: " + dayDelta
